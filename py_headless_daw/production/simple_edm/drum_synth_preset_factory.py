...
class SimpleEdmDrumSynthPresetFactory:
    ...
    def generate_bd_preset(self, seed: Seed) -> PluginPreset:
        ...
        oscillator_param_data = {
            ...
            DrumSynthPlugin.PARAM_NAME_SUFFIX_OSCILLATOR_VOLUME_ENVELOPE_DECAY_TIME: 0.2,
        ...
        for name, value in global_param_data.values():
            res.set_parameter_value(name, value)

        for name_prefix, value in oscillator_param_data.values():
            param_name = name_prefix + "1"
